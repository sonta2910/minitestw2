package com.example.picture_shop.config;

import com.example.picture_shop.formatter.CategoryFormatter;
import com.example.picture_shop.formatter.PictureFormatter;
...
@Configuration
@ComponentScan("com.example.picture_shop")
@EnableWebMvc
@EnableTransactionManagement
@EnableJpaRepositories("com.example.picture_shop.repository")
public class AppConfig implements WebMvcConfigurer, ApplicationContextAware {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.example.picture_shop.model");
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/picture_shop?useSSL=false");
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addFormatter(new PictureFormatter(applicationContext.getBean(IPictureService.class)));
